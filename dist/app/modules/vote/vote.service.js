...
const NotAcceptable_1 = __importDefault(require("../../errors/NotAcceptable"));
const paginationHelper_1 = require("../../builder/paginationHelper");
const idea_utilities_1 = require("../idea/idea.utilities");
const createOrUpdateVote = (userEmail, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!idea) {
        throw new NotFound_1.default('Idea not found');
    }
    if (idea.status !== 'APPROVED') {
        throw new NotAcceptable_1.default('Cannot vote on ideas that are not approved');
    }
...
const removeVote = (userEmail, ideaId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!vote) {
        throw new NotFound_1.default('Vote not found');
    }
    // Delete the vote
